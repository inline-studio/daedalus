...
| IMP-01 | Improvement | Medium | `web/fetch.ts:22` vs `kernel/ingest.ts:209` | Two divergent `fetchUrl` impls; the weaker one has no caps/SSRF guard |
